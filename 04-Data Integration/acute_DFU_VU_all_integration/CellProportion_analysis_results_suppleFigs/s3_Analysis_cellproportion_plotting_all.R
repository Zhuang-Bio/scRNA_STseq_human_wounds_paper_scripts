...
# run the KC
alldf <- data.table::fread("../cellproportion_analysis_results/allInte_CellType_Keratinocyte_cellproportion.txt")
alldf <- data.table::fread("../cellproportion_analysis_results/allInte_CellType_Fibroblast_cellproportion.txt")
alldf <- data.table::fread("../cellproportion_analysis_results/allInte_CellType_Myeloid_cellproportion.txt")
alldf <- data.table::fread("../cellproportion_analysis_results/allInte_CellType_Lymphoid_cellproportion.txt")
alldf <- data.table::fread("../cellproportion_analysis_results/allInte_CellType_Endothelium_cellproportion.txt")
