...
kc <- data.table::fread("/Users/zhuliu/Desktop/sc st/Versions_SC_ST_Project/V2_Figures_231017/01-Scripts/Figures_all_integration/01-keratinocyte/allacuteWound_DFU_VU_inteKC_metadata.txt") %>% select(1,20)
fb <- data.table::fread("/Users/zhuliu/Desktop/sc st/Versions_SC_ST_Project/V2_Figures_231017/01-Scripts/Figures_all_integration/02-fibroblast/allacuteWound_DFU_VU_inteFB_metadata.txt") %>% select(1,21)
mye <- data.table::fread("/Users/zhuliu/Desktop/sc st/Versions_SC_ST_Project/V2_Figures_231017/01-Scripts/Figures_all_integration/03-myeloid/allacuteWound_DFU_VU_inteMyeloid_metadata.txt") %>% select(1,21)
lym <- data.table::fread("/Users/zhuliu/Desktop/sc st/Versions_SC_ST_Project/V2_Figures_231017/01-Scripts/Figures_all_integration/04-lymphoid/allacuteWound_DFU_VU_inteLymphoid_metadata.txt") %>% select(1,20)
endo <- data.table::fread("/Users/zhuliu/Desktop/sc st/Versions_SC_ST_Project/V2_Figures_231017/01-Scripts/Figures_all_integration/05-endo/allacuteWound_DFU_VU_inteEndo_metadata.txt") %>% select(1,20)
...
library(scCustomize)
FeaturePlot_scCustom(inteData, features = c("CXCL1"), split.by = "Condition", num_columns = 5)
DimPlot(inteData, group.by = "mainCellType", label = T, cols = ct.cols)
...
DotPlot(inteData, features = c("CXCL1"), 
                       group.by = "mainCellType", cols = c("white", "#cb181d"), 
        split.by = "Condition",
...
jjDotPlot(object = mac, 
          ...
          id="mainCellType",
          split.by = "Condition",
          cluster.order = unlist(lapply(rev(levels(mac$mainCellType)), FUN = function(x) paste0(x, " (",rev(levels(mac$Condition)), ")"))),
          split.by.aesGroup = T,
          rescale = T,
          rescale.min = 0,
          rescale.max = 1) + 
...
VlnPlot_scCustom(inteData, features = c("CXCL1"), group.by = "mainCellType", plot_median = TRUE, pt.size = 0) & NoLegend()
VlnPlot_scCustom(inteData, features = c("CXCL1"), group.by = "mainCellType", split.by = "Condition")
FeaturePlot_scCustom(inteData,  features = c("CXCL1"), split.by = "Condition", 
                     num_columns = 3)
```


# EGF, HGF signaling in acute and chronic wounds
```{r}
