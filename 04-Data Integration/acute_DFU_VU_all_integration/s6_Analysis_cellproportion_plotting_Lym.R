...
#Bcell ILC1_NK    ILCs      NK  Plasma      Tc      Th    Treg    Ttol 
#41      41      41      41      41      41      41      41      41 

# choose the cell types for plotting
alldf_test <- alldf %>% dplyr::filter(newCellType == "Th")
alldf_test <- alldf %>% dplyr::filter(newCellType == "Plasma")
...
# combine the plots
#pdf("Result_CellProportion_allInte_Lym_Th.pdf", useDingbats = FALSE, width = 4, height = 2)
pdf("Result_CellProportion_allInte_Lym_Plasma.pdf", useDingbats = FALSE, width = 4, height = 2)
