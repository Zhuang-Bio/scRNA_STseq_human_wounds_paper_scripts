...
seu_obj <- readRDS(paste0(output_path, "s1_clean_immu_lymphoid_newUMAP.rds"))
...
```{r}
# build KNN graph
seu_milo <- buildGraph(seu_milo, k = 30, d = 20, reduced.dim = "HARMONY")

# Defining representative neighbourhoods on the KNN graph
seu_milo <- makeNhoods(seu_milo, prop = 0.1, k = 30, d = 20, refined = TRUE, reduced_dims = "HARMONY", refinement_scheme="reduced_dim")
...
pdf("Milo_Lym_wound1_skin.pdf", useDingbats = FALSE, width = 12, height = 6)
dev.off()
...
# Draw the plot
da_results$nh_graph_pl + 
  (da_results$beeplot + scale_y_continuous(breaks = c(-6,-4,-2,0,2,4,6), limits = c(-2.5,4))) + 
  plot_layout(widths = c(1.6, 1))
pdf("Milo_Lym_wound7_wound1.pdf", useDingbats = FALSE, width = 12, height = 6)
dev.off()
...
# Draw the plot
da_results$nh_graph_pl + 
  (da_results$beeplot + scale_y_continuous(breaks = c(-6,-4,-2,0,2,4), limits = c(-3,3))) + 
  plot_layout(widths = c(1.6, 1))
pdf("Milo_Lym_wound30_wound7.pdf", useDingbats = FALSE, width = 12, height = 6)
dev.off()
```
...
# Draw the plot
da_results$nh_graph_pl + 
  (da_results$beeplot + scale_y_continuous(breaks = c(-6,-4,-2,0,2,4), limits = c(-4,5.6))) + 
  plot_layout(widths = c(1.6, 1))
pdf("Milo_Lym_wounds_skin.pdf", useDingbats = FALSE, width = 12, height = 6)
dev.off()
