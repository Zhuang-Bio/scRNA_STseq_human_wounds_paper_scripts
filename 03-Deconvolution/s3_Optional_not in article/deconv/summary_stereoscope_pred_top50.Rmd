...
Stereoscope was run for all sections using the scRNAseq data and gene list with top50 genes at each branch of the cluster tree.
...
Size of point is proportional to proportion of the celltype
